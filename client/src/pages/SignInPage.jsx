    ...
    <div className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center p-6 font-sans select-none transition-colors duration-300"
      ...
      <div className="relative z-10 flex flex-col items-center mb-7">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1 rounded-full"
          ...
          <span className="text-[11px] font-semibold text-blue-400">Manufacturing Platform</span>
        </div>
      </div>
        ...
        <SignIn
          ...
          appearance={{
            ...
            elements: {
              ...
              /* Google – colored border to match its brand style */
              ...
              /* Apple – white background so the black Apple logo is visible */
